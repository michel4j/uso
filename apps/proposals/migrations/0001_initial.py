    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('category', models.CharField(choices=[('diffraction', 'Diffraction/Scattering'), ('imaging', 'Imaging'), ('microscopy', 'Microscopy'), ('spectroscopy', 'Spectroscopy'), ('other', 'Other')], default='other', max_length=50, verbose_name='Category')),
